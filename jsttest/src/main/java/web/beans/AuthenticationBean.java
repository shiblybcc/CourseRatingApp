...
import web.authentication.AuthenticationResult;
import web.authentication.L2pAccess;
import web.authentication.OAuthHelper.TokenListener;
...
public class AuthenticationBean extends AbstractBean {
	...
	public void getAuthenticationURL() {
		if (!canRedirectToAuthenticationURL()) {
